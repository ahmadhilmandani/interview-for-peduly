...
export function StepOne(props) {
    ...
    return (
        <>
            ...
            <div className={index < 5 ? "bg-white py-3 px-5 fixed bottom-0 left-0 right-0 shadow-[0px_-1px_12px_rgba(0,0,0,0.08)] lg:static lg:shadow-none lg:rounded-b-md z-50": 'hidden'} >
                <div className='flex justify-end'>
                    {
                        index < 5 ?
                            <PrimaryButton size={'sm'} additional='opacity-50 hover:opacity-100' onClick={() => {
                                setIndex(index + 1)
                            }}>
                               Siapp..
                            </PrimaryButton>
